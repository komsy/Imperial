...
$category = Booking::find()->where(['doctor.userId'=>Yii::$app->user->id ])->andWhere(['status'=>'pending'])->joinWith('doctor')->joinWith('category0')->joinWith('patient')->all();
    ...
    <div class="col-md-3">
      <div class="card log">
        <div class="card-body">
            <div class="row text-center" >
                <div class="col" > 
                    <button class="btn btn-dark info"> My Info </button>
                </div>
            </div>
